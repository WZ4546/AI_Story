  ...
  return (
    ...
    >
      <div className="bg-white max-w-lg w-full rounded-xl p-8 card">
        ...
        <h1 className="text-center font-semibold text-gray-600 mt-3">🦋 A place to spend time with your AI lover 🦋</h1>
        <div className="flex flex-col lg:flex-row justify-between mt-5">
          ...
          <div className="flex flex-col w-full lg:w-1/2 h-full lg:ml-5 mt-5 lg:mt-0">
            <h1 className="text-black font-serif font-bold text-xl text-center">Login</h1>
            ...
            <p className="mt-3 text-center text-black">
              Don't have an account? <Link to="/register" className="text-blue-600 font-bold">  Sign up here</Link>.
            </p>
          </div>
        </div>
      </div>
